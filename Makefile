...
db:
	PGPASSWORD=superroot psql -h postgres -U root -d casemanagementadb -f setup_db_a.sql; PGPASSWORD=superroot psql -h postgres -U root -d casemanagementbdb -f setup_db_b.sql
