from case_management_api.dependencies import postgres
import datetime
import json
            ...
            if "postgres" in value:
                ...
                if depth > 0:
                    ...
                    try:
                        ...
                        current_app.logger.error("Connection Aborted during health cascade on attempt to "
                                                 "connect to {}; full error: {}".format(dependency, e))
